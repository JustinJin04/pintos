...
bool spage_install_mmap(void* upage, struct file* file, off_t offset, size_t read_bytes, size_t zero_bytes, bool writable);
...
void spage_remove(struct spage_table_entry* se);
//void spage_free(struct spage_table_entry* se);
